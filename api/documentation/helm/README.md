# ocatiecatalogus chart

The Helm chart installs ocatiecatalogus and by default the following dependencies using subcharts:
...
```bash
helm install my-ocatiecatalogus  --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `ocatiecatalogus` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `ocatiecatalogus` |
